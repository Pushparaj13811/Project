    ...
    return (
        <footer className="bg-white dark:bg-gray-900 border-y">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <hr className="my-6 border-gray-200 dark:border-gray-100 sm:mx-auto lg:my-8" />
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <Link to="#" className="text-gray-500 dark:text-white dark:hover:text-gray-100 hover:text-gray-900">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
