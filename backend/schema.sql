...
--
-- Host: localhost    Database: project-php
-- ------------------------------------------------------
...
CREATE TABLE `close_friends` (
  ...
  CONSTRAINT `close_friends_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `close_friends_ibfk_2` FOREIGN KEY (`friend_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
CREATE TABLE `notifications` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `type` enum('new_story','reaction','reply','follow_request') NOT NULL,
...
CREATE TABLE `reactions` (
  ...
  `user_id` int NOT NULL,
  `type` enum('like','heart','smile') NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `story_id` (`story_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `reactions_ibfk_1` FOREIGN KEY (`story_id`) REFERENCES `stories` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `replies` (
  ...
  KEY `story_id` (`story_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `replies_ibfk_1` FOREIGN KEY (`story_id`) REFERENCES `stories` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `stories` (
  ...
  `content` text NOT NULL,
  `visibility` enum('public','private','friends','friends_of_friends','close_friends') NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`Pushparaj`@`localhost`*/ /*!50003 TRIGGER `set_expires_at` BEFORE INSERT ON `stories` FOR EACH ROW BEGIN
...
-- Dump completed on 2024-06-13 11:06:57
